...
namespace hw1
{
    class Inside : Temperature
    {
        public Inside() { }
        public Inside(string name, int currentvalue, int min_value, int max_value)
        ...
        public override void ConvertToFahrenheit()
        {
            if (demension == Demension.celsius)
            {
                ...
                Console.WriteLine("Значение комнатной темпеарутры переведены из цельсий в фаренгейты");
            }
            if (demension == Demension.kelvin)
            {
                ...
                Console.WriteLine("Значение комнатной темпеарутры переведены из кельвин в фаренгейты");
            }
            else
            {
        ...
        public override void ConvertToKelvin()
        {
            if (demension == Demension.celsius)
            {
                ...
                Console.WriteLine("Значение комнатной темпеарутры переведены из цельсий в кельвины");
            }
